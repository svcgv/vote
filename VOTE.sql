...
DROP TABLE "VOTE"."COST_INFO";
CREATE TABLE "VOTE"."COST_INFO" (
"COST_ID" VARCHAR2 (16) NOT NULL ,
"ORG_ID" NUMBER(16) NULL ,
"IS_DELETE" CHAR(1),
PRIMARY KEY ("COST_ID")
)
LOGGING
...
DROP TABLE "VOTE"."PROFIT_INFO";
CREATE TABLE "VOTE"."PROFIT_INFO" (
"PROFIT_ID" VARCHAR2 (16) NOT NULL ,
"ORG_ID" NUMBER(16) NULL ,
"IS_DELETE" CHAR(1),
...
--100008角色管理
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000801,'新增','按钮新增','角色管理','20181118',100008);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000802,'修改','角色修改','角色管理','20181118',100008);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000803,'删除','角色删除','角色管理','20181118',100008);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000804,'权限分配','角色权限分配','角色管理','20181118',100008);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000805,'按钮分配','角色按钮分配','角色管理','20181118',100008);
--100009按钮管理
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000901,'新增','按钮新增','按钮管理','20181118',100009);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000902,'修改','按钮修改','按钮管理','20181118',100009);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000903,'删除','按钮删除','按钮管理','20181118',100009);
--100002用户管理
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000201,'新增','用户新增','用户管理','20181118',100002);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000202,'修改','用户修改','用户管理','20181118',100002);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000203,'注销','用户注销','用户管理','20181118',100002);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000204,'启用','用户启用','用户管理','20181118',100002);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000205,'禁用','用户禁用','用户管理','20181118',100002);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000206,'设置角色','用户设置角色','用户管理','20181118',100002);
--100003参数管理
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000301,'新增','参数新增','参数管理','20181118',100003);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000302,'修改','参数修改','参数管理','20181118',100003);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000303,'注销','参数注销','参数管理','20181118',100003);
--100007机构管理
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000701,'新增','机构新增','机构管理','20181118',100007);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000702,'修改','机构修改','机构管理','20181118',100007);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000703,'注销','机构注销','机构管理','20181118',100007);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000704,'启用','机构启用','机构管理','20181118',100007);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000705,'关闭','机构关闭','机构管理','20181118',100007);
--100004菜单管理
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000401,'新增','菜单新增','菜单管理','20181118',100004);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000402,'修改','菜单修改','菜单管理','20181118',100004);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000403,'注销','菜单注销','菜单管理','20181118',100004);
--100005数据字典
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000501,'新增','数据字典新增','数据字典管理','20181118',100005);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000502,'修改','数据字典修改','数据字典管理','20181118',100005);
Insert into BTN_INFO (BTN_ID,BTN_NAME,BTN_RMK,BTN_PAGE,TM_SMP,MENU_ID) values (10000503,'注销','数据字典注销','数据字典管理','20181118',100005);
