...
<head>
    ...
    <link rel="stylesheet" href="${ctx }/resources/WeChat/css/addressYKT.css">   
    ...
    $(document).ready(function(){
    	...
    	for(var i=0; i<data.length; i++){
    		...
    		$("ul").append('<li onclick="getUnvotedInfoDetails(\''+openId+'\',\''+data[i].topicId+'\')"><div>'
    				+data[i].topicName+'</div></li>');
    	}
    	console.log($("ul").html());
    	$("#vote").attr("href", "${ctx }/WeChat/vote/changeVotedInfo?openId="+openId);
    });
    
    function getUnvotedInfoDetails(openId, topicId){
    	console.log(openId);
    	console.log(topicId);
    	/*
...
<body>
<div id="ct">
	<form id="i-form" name="from-name" method="get" action="${ctx }/WeChat/vote/getUnvotedInfoDetails">
