...
<script type="text/javascript">
	...
	function save() {
		...
		$.indi.ajaxSubmit({url: "${ctx}/cspstaff/saveCspInfo",success:function(data){
			if(data.status == true){
				layer.alert('人员信息编辑成功！',{icon: 1}, function(index){
					window.parent.qryList();
					$.indi.closePopup();
				});  
			}else{
				layer.alert('人员信息编辑失败！',{icon: 2});
			}
			}});
	}
...
<body class="body-modle">
	<div  class=content >
		<div class="row">
			...
			<input type="hidden" id="gsryid" name="gsryid" value="${staff.gsryid}" >
