			  ...
			  <input type="hidden" id="sjzt" name="sjzt" value="${sjzt}"/>
				...
				<div class="form-group">
					...
					<div class=" col-xs-8">
							...
							placeholder="物业公司名称" id="wygsmc" name="wygsmc" minlength="2" maxlength="40" />
					</div> 
				...
				<label class="col-xs-2 control-label text-right">物业公司地址</label>
					<div class=" col-xs-8">
							<input type="text" class="form-control col-xs-11"
							placeholder="物业公司地址" id="wygsdz" name="wygsdz" minlength="2" maxlength="200" />
					</div>
				</div> 
				...
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="社会信用代码" id="shxydm" name="shxydm" minlength="10" maxlength="18" />
					</div> 
					<label class="col-xs-2 control-label text-right">营业执照号</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="营业执照注册号" id="yyzzbh" name="yyzzbh" minlength="10" maxlength="18" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="资质编号" id="zzbh" name="zzbh" minlength="10" maxlength="18" />
					</div> 
				</div>	
				...
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="注册证照有效期" id="zczzyxq" name="zczzyxq" onClick="WdatePicker()" minlength="10" maxlength="10" />
					</div> 
					<label class="col-xs-2 control-label text-right">Email邮箱</label>
					<div class=" col-xs-3"> 
						   <input type="text" class="form-control col-xs-11"
							placeholder="Email邮箱" id="qyyx" name="qyyx" minlength="5" maxlength="80"   email="true" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							...
							placeholder="注册资本" id="zczb" name="zczb" minlength="1" maxlength="4" />
					</div> 
					<label class="col-xs-2 control-label text-right">成立日期</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="成立日期" id="clrq" name="clrq" onClick="WdatePicker()"  minlength="10" maxlength="10" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="从物业管理活动时间" id="wyglsj" name="wyglsj" onClick="WdatePicker()" minlength="10" maxlength="10" />
					</div> 
					
					<label class="col-xs-2 control-label text-right">企业电话</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="企业电话" id="qydh" name="qydh" minlength="8" maxlength="12" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="注册地址" id="zcdz" name="zcdz" minlength="2" maxlength="200" />
					</div> 
					<label class="col-xs-2 control-label text-right">办公地址</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="办公地址" id="bgdz" name="bgdz" minlength="2" maxlength="200" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="企业传真" id="qycz" name="qycz" minlength="6" maxlength="6" />
					</div> 
					<label class="col-xs-2 control-label text-right">企业邮编</label>
					<div class=" col-xs-3">
							<input type="number" class="form-control col-xs-11"
							placeholder="企业邮编" id="qyyb" name="qyyb" minlength="6" maxlength="6" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="法人代表" id="frdb" name="frdb" minlength="1" maxlength="20" />
					</div> 
					<label class="col-xs-2 control-label text-right">法人手机</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="法人手机" id="frsj" name="frsj" minlength="11" maxlength="11" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="企业联系人" id="qylxr" name="qylxr" minlength="1" maxlength="20" />
					</div> 
					<label class="col-xs-2 control-label text-right">联系人电话</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="联系人电话" id="lxrdh" name="lxrdh" minlength="11" maxlength="11" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-8">
							<input type="text" class="form-control col-xs-11"
							placeholder="企业概况" id="qygk" name="qygk" minlength="1" maxlength="200" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-8">
							<input type="text" class="form-control col-xs-11"
							placeholder="经营范围" id="zyfw" name="zyfw" minlength="1" maxlength="200" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-8">
							<input type="text" class="form-control col-xs-11"
							placeholder="备注" id="bz" name="bz" minlength="1" maxlength="200" />
					</div>
				</div>
