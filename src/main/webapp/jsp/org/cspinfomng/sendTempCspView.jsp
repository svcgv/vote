...
<body class="body-modle">
	<div  class=content >
		<div class="row">
			...
			<input type="hidden" id="_appId" name="appId" value="${csp.app_id}"/>
			<input type="hidden" id="_taskId" name="taskId" value="${app.taskId }"/>
			<input type="hidden" id="app_id" name="app_id" value="${csp.app_id}"/>
			 <input type="hidden" name="wygsid" value="${csp.wygsid}" >
			 <input type="hidden" id="sjzt" name="sjzt" value="${csp.sjzt}"/>
