...
<script type="text/javascript">
	...
	function save() {
		...
		$.indi.ajaxSubmit({url: "${ctx}/community/saveCommunityInfo",success:function(data){
			if(data.status == true){
				layer.alert('居委会信息新增成功！',{icon: 1}, function(index){
					window.parent.qryList();
					$.indi.closePopup();
				});  
			}else{
				layer.alert('居委会信息新增失败！',{icon: 2});
			}
			}});
	}
	//关闭当前弹出框
			...
			<form method="post" id="i-form" class="form-horizontal">
				<div class="form-group">
					...
					<div class=" col-xs-8">
							...
							placeholder="居委会名称" id="jwhmc" name="jwhmc" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="居委会编码" id="jwhbm" name="jwhbm" />
					</div> 
				...
				<div class="form-group">
					...
					<div class=" col-xs-8">
							<input type="text" class="form-control col-xs-11"
							placeholder="居委会地址" id="jwhdz" name="jwhdz" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="居委主任" id="jwzr" name="jwzr" />
					</div> 
					<label class="col-xs-2 control-label text-right">居委主任电话</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="居委主任电话" id="jwzrdh" name="jwzrdh" maxlength="18" minlength="6"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="居委书记" id="jwsj" name="jwsj" />
					</div> 
					<label class="col-xs-2 control-label text-right">纪委书记电话</label>
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="纪委书记电话" id="jwsjdh" name="jwsjdh" maxlength="18" minlength="6"/>
					</div>
				</div>
				<div class="form-group">
