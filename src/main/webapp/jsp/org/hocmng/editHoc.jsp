...
<script type="text/javascript">
	...
	function save() {
		...
		$.indi.ajaxSubmit({url: "${ctx}/hoc/editHocInfo",success:function(data){
			if(data.status == true){
				layer.alert('业委会信息编辑成功！',{icon: 1}, function(index){
					$.indi.closePopup();
					window.parent.qryList();
				});  
			}else{
				layer.alert('业委会信息编辑失败！',{icon: 2});
			}
			}});
	}
	//关闭当前弹出框
	...
	<div  class=content >
		<div class="row">
			<form method="post" id="i-form" class="form-horizontal">
			 <input type="hidden" name="ywhid" value="${hoc.ywhid}" >
			 <input type="hidden" id="zrywhryid" name="zrywhryid" value="${zr.ywhryid}">
			 <input type="hidden" id="ylywhryid" name="ylywhryid" value="${yl.ywhryid}">
			 <input type="hidden" id="fzrywhryid" name="fzrywhryid" value="${fzr.ywhryid}">
	 		...
	 		<div class="form-group" style="text-align: center;font-weight: bold;color: blue;" > 业委会信息</div> 
				...
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="邮箱Email" id="zrryyx" name="zrryyx" value="${zr.ryyx}" minlength="8" maxlength="40" email="true"/>
					</div> 
				</div>   
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="邮箱Email" id="ylryyx" name="ylryyx" value="${yl.ryyx}" minlength="8" maxlength="40" email="true" />
					</div> 
				</div>   
				<div class="form-group">
					<label class="col-xs-2 control-label text-right">上任日期</label>
				...
				<div class="form-group">
					...
					<div class=" col-xs-3">
							<input type="text" class="form-control col-xs-11"
							placeholder="邮箱Email" id="fzrryyx" name="fzrryyx" value="${fzr.ryyx}" minlength="8" maxlength="40" email="true" />
					</div> 
				</div>   
				<div class="form-group">
					<label class="col-xs-2 control-label text-right">上任日期</label>
