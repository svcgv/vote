...
<script type="text/javascript">
	...
	function save() {
		...
		$.indi.ajaxSubmit({url: "${ctx}/credit/quota/updateQuotaInfo.do",success:function(data){
			layer.alert("诚信指标信息修改成功!",{icon: 1},function(index){
				$.indi.closePopup();
				...
				<div class="form-group">
					...
					<div class="col-xs-8">
						<input type="text" class="form-control"
							placeholder="第几条,如第一条，则填写大写'一'即可..." id="tseq" name="tseq"  maxlength="80" value="${quota.tseq}"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class=" col-xs-8">
						<input type="text" class="form-control col-xs-10"
							placeholder="第几款,如第五款，则填写大写'五'即可..." id="kseq" name="kseq"  maxlength="80" value="${quota.kseq}"/>
					</div>
				</div>
				<div class="form-group">
