...
<body class="body-modle">
	<div  class=content >
		...
		<div class="row">
			...
			<input type="hidden" id="credit_code" name="credit_code" value=""/>
			<input type="hidden" id="_appId" name="appId" value="${app.appId}"/>
			<input type="hidden" id="_nextOrgId" name="nextOrgId" value="${app.nextOrgId}"/>
			<input type="hidden" id="credit_status" name="credit_status" value="${credit_status}"/>
			...
			<input type="hidden" id="zblx" name="zblx" value="<%=InitSysConstants.CreditQuotaKind_BL%>"/>
				...
				<div class=" col-md-12" id="_baseInfo">
					...
					<div class="form-group">
						...
						<div class=" col-xs-4 ">
							<input type="text" class="form-control"
								placeholder="受理日期" id="jlrq" name="jlrq" value="<%=DateUtil.formatFromDB(DateUtil.getSysDate())%>" onClick="WdatePicker()"/>
					...
					<div class="form-group">
						...
						<div class="col-xs-4">
							<select  class="form-control col-xs-7 " id="hpbid" name="hpbid" >
								${cm:createRegionHtml(hpbList,ishpbid) }
							</select>
						</div>
					...
					<div class="form-group">
						...
						<div class=" col-xs-9">
							<input type="text" class="form-control col-xs-10" placeholder="请选择涉及的小区" id="xmmc" name="xmmc"  maxlength="80" value="" />
					...
					<div class="form-group">
						...
						<div class="col-xs-9">
							<input type="text" class="form-control col-xs-10" placeholder="请选择物业服务企业" id="wygsmc" name="wygsmc" maxlength="80" />
						</div>
					...
					<div class="form-group">
						...
						<div class=" col-xs-10">
							<input type="text" class="form-control col-xs-10"
								placeholder="项目经理姓名" id="ryxm" name="ryxm"  maxlength="80" value="" />
							<p class="help-block"></p>		
							<input type="hidden" id="gsryid" name="gsryid" value=""/>		
						</div>
						<input type="hidden" id="xmjlid" name="xmjlid" value=""/>		
					</div>
					<div class="form-group">
						<label class="col-xs-2 control-label text-right">受理内容</label>
						<div class=" col-xs-10">
							<textarea type="text" class="form-control col-xs-11" 
								placeholder="不良信息内容描述" id="slnr" name="slnr" rows="5" maxlength="512"></textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class=" col-xs-10">
							<textarea type="text" class="form-control col-xs-11" 
								placeholder="描述" id="remark" name="remark" rows="5" maxlength="512"></textarea>
						</div>
					</div>
				</div>	
				<div class="collapse col-md-12" id="_file_info">
					<div class="col-md-12 paddtop10">
						<span style="color: #72afd2">对应要件</span> <span style="color: red">&nbsp;&nbsp;*上传前请签收选中的附件资料</span>
						<hr>
					</div>
					<div class="col-md-12 paddtop10">
						<table class="table table-bordered table-striped table-paging">
							...
							<c:forEach items="${fileSigns}" var="file" varStatus="fileSta">
								<tr>
									<td align="center">
										<input type="checkbox" value="${file.signId}" name="signIds"/>
									</td>
