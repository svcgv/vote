...
<script type="text/javascript">
	...
	function print(){
		...
		if(!res.form()){
			...
			$.indi.ajaxSubmit({url: "${ctx}/credit/badrecord/saveNotifyInfo.do",success:function(data){
	...
	<div  class=content >
		...
		<div class="form-horizontal">
			...
			<div class="collapse col-md-12" id="_notify_info">
				...
				<div class="form-group">
					...
					<div class=" col-xs-4">
						...
						<p class="help-block"></p>	
						<input type="hidden" id="gzsj" name="gzsj" value="<%=DateUtil.getSysTime()%>"/>	
					</div>
				</div> 
				<div class="form-group">
			...
			<div class="form-group paddtop10" align="center">
				...
				<button type="button" class="btn btn-primary" onclick="sendfward()">
					<i class="icon-bell"></i>告知
				</button>
				<button type="button" class="btn btn-primary" onclick="backward()">
					<i class="icon-backward"></i>退回
				</button>
