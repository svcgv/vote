			...
			<input type="hidden" id="zblx" name="zblx" value="<%=InitSysConstants.CreditQuotaKind_BL%>"/>
				...
				<div class="collapse col-md-12" id="_file_info">
					<div class="form-group">
						...
						<div class=" col-xs-11">
							<textarea type="text" class="form-control col-xs-11" 
								placeholder="异议申诉理由" id="slnr" name="appeal_reasion" rows="5" maxlength="512"></textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class=" col-xs-11">
							<textarea type="text" class="form-control col-xs-11" 
								placeholder="其他说明" id="appeal_remark" name="appeal_remark" rows="5" maxlength="512"></textarea>
						</div>
					</div>
