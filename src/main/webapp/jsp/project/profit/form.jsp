...
<div id="profit-form-hook" class="profit-form-wrapper" style="margin-top:10px;">
		    ...
		    <div class="layui-inline">
			      <label class="layui-form-label">利润中心编号：</label>
			       <div class="layui-input-inline">
			         <input type="text" name="profitId"  autocomplete="off" class="layui-input form-control">
...
$(function(){
	...
	// form 表单手动渲染
	  ...
	  // 选择销售部门
	  $("#profit-form-hook #costOrgNameQuery-hook").click(function(){
		  $.openWindow({
	...
	var win=$("#profit-form-hook").getWindow();
	// 保存
	$("#profit-form-hook #customGroup-add-hook").click(function(){
		
		var formDatas=$("#profit-form-hook form").serializeObject();
		 var newparam = {}
	...
	// 关闭
	$("#profit-form-hook #customerGroup-close-hook").click(function(){
		win.close();
		return false;
	})
