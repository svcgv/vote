	...
	$(".project-user-wrapper").on("click","#save-hook",function(){
		...
		$(".project-user-wrapper .layui-table-body table.layui-table tbody tr").each(function(){
			...
			if(isChecked){
				...
				if(act == "projectManager"){
					// index
					$("#projectApprove-index-form input[name='projectManagerName']").val(userName);
					$("#projectApprove-index-form input[name='projectManagerId']").val(userId);
