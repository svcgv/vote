		   ...
		   <div class="layui-form-item" style="margin-bottom:0px;">
	 	   ...
	 	   <div class="layui-inline" style="vertical-align: top;">
			   <div class="layui-btn-container" style="margin-left:15px;">
			    ...
			    <button type="button" class="layui-btn layui-btn-sm" power="108401" id="customAdd"  style="margin-right:15px;"><i class="layui-icon"></i>新增</button>
			  </div>
		   </div>
	   </div>
	</form>
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" power="108402" lay-event="edit">编辑</a>
  <a class="layui-btn layui-btn-xs layui-btn-xs" power="108403" lay-event="view">查看</a>
  <a class="layui-btn layui-btn-danger layui-btn-xs" power="108404" lay-event="del">删除</a>
</script>
