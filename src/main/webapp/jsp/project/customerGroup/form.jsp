...
<body>
<style>
    .formDetail-wrapper .layui-form-label {
        width: 130px;
    }
...
<div id="form-customer-hook" class="formDetail-wrapper  <c:if test="${act =='view'}">form-view</c:if>"
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="custGroupName"
                           <c:if test="${act =='view'}">disabled=true</c:if> autocomplete="off"
