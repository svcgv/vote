						...
						<tr>
							<td>
								<div class="layui-inline" style="min-width: 250px;">
									<div class="layui-input-inline item">
										<label>${app.custName}</label> <input type="hidden"
											name="custName" value="${app.custName}" /> <input
											type="hidden" name="custId" value="${app.sapCode}" />
									</div>
								</div>
								<div>
									<button type="button"
										class="layui-btn layui-btn-sm addProjectQuery-hook"
										style="vertical-align: top;">
										<i class="layui-icon"></i>新增项目
									</button>
									<button type="button" custId="longshangCode"
										class="layui-btn layui-btn-sm deleteCustomer-hook"
										style="vertical-align: top; background-color: #FF5722;">
							...
							<td>
								<div class="project-list">
									...
									<div class="layui-input-inline item copyAddItem">
										...
										<button type="button"
											class="layui-btn layui-btn-sm WBSQuery-hook">
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										...
										<div class="layui-input-inline item ">
											<c:if test="${app2.wbs == null}">
													<input type="text" name="projectName" value="${app2.projectName}" />
												
											</c:if>
											<c:if test="${app2.wbs != null}">
												<span class="layui-badge-dot layui-bg-green"></span><span>${app2.projectName}</span>
												<input type="hidden" name="projectName"
													value="${app2.projectName}" />
									...
									<div class="layui-input-inline item copyAddItem">
										...
										<button type="button"
											class="layui-btn layui-btn-sm projectNameQuery-hook">
											<i class="layui-icon layui-icon-search "></i>
										</button>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.projectType}</span> <input type="hidden"
												name="projectType" value="${app2.projectType}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
							...
							<td>
								<div class="project-list">
									<div class="layui-input-inline">
										<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
											<c:if test="${app2.productNames != null }">
											<div class="layui-input-inline item">
													<span>是</span> 
													<input type="hidden" name="isChooseProduct" value="00" />
													</div>
											</c:if>
											<c:if test="${app2.productNames == null }">
											<div class="layui-input-inline item">
									...
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<select name="isChooseProduct"
												lay-filter="isChooseProduct-filter" class="form-control">
												<option value="">请选择</option>
												<option value="00" selected>是</option>
							...
							<td>
								<div class="project-list">
									...
									<div class="layui-input-inline productItem copyAddItem">
										<button type="button"
											class="layui-btn layui-btn-sm productQuery-hook"
											style="vertical-align: top;">
											<i class="layui-icon layui-icon-search "></i>
										</button>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetYear}年</span> <input type="hidden"
												name="budgetYear" value="${app2.budgetYear}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.custManagerName}</span> <input type="hidden"
												name="custManagerId" value="${app2.custManagerId}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.taxType}</span> <input type="hidden"
												value="${app2.taxType}" name="taxType" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<select name="taxType" lay-verify="required"
												class="form-control"> ${taxType.ewTypeHtml}
											</select>
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.revRecognitionMethod}</span> <input
												type="hidden" value="${app2.revRecognitionMethod}"
												name="revRecognitionMethod" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.region}</span> <input type="hidden"
												value="${app2.region}" name="region" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.currency}</span> <input type="hidden"
												value="${app2.currency}" name="currency" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
							...
							<td>
								<div class="project-list">
									...
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.taxRate}</span> <input type="hidden"
												value="${app2.taxRate}" name="taxRate" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.grossProfitRate}</span> <input type="hidden"
												value="${app2.grossProfitRate}" name="grossProfitRate" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="grossProfitRate"
												class="layui-input form-control" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list contractMoney">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.contractMoney}</span> <input type="hidden"
												value="${app2.contractMoney}" name="contractMoney" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="contractMoney"
												class="layui-input form-control" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list manyYearRev">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.manyYearRev}</span> <input type="hidden"
												value="${app2.manyYearRev}" name="manyYearRev" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
							...
							<td>
								<div class="project-list curYearRev">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.curYearRev}</span> <input type="hidden"
												value="${app2.curYearRev}" name="curYearRev" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline"></div>
							...
							<td>
								<div class="project-list lastRev">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.lastRev}</span> <input type="hidden"
												value="${app2.lastRev}" name="lastRev" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="lastRev"
												class="layui-input form-control" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetSum}</span> <input type="hidden"
												name="budgetSum" value="${app2.budgetSum}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" readonly="readonly" name="budgetSum"
												class="layui-input form-control disabledColor" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.afterTax}</span> <input type="hidden"
												name="afterTax" value="${app2.afterTax}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" readonly="readonly" name="afterTax"
												class="layui-input form-control disabledColor" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetJan}</span> <input type="hidden"
												name="budgetJan" value="${app2.budgetJan}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetJan"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							</td>
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetFeb}</span> <input type="hidden"
												name="budgetFeb" value="${app2.budgetFeb}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetFeb"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetMar}</span> <input type="hidden"
												name="budgetMar" value="${app2.budgetMar}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetMar"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetApr}</span> <input type="hidden"
												name="budgetApr" value="${app2.budgetApr}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetApr"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetMay}</span> <input type="hidden"
												name="budgetMay" value="${app2.budgetMay}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetMay"
												class="layui-input form-controlj-monthCalc" />
										</div>
									</div>
								</div>
							</td>
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetJun}</span> <input type="hidden"
												name="budgetJun" value="${app2.budgetJun}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetJun"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetJul}</span> <input type="hidden"
												name="budgetJul" value="${app2.budgetJul}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetJul"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetAug}</span> <input type="hidden"
												name="budgetAug" value="${app2.budgetAug}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetAug"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetSep}</span> <input type="hidden"
												name="budgetSep" value="${app2.budgetSep}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetSep"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetOct}</span> <input type="hidden"
												name="budgetOct" value="${app2.budgetOct}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetOct"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetNov}</span> <input type="hidden"
												name="budgetNov" value="${app2.budgetNov}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetNov"
												class="layui-input form-control j-monthCalcj-monthCalc" />
										</div>
									</div>
								</div>
							</td>
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item">
											<span>${app2.budgetDec}</span> <input type="hidden"
												name="budgetDec" value="${app2.budgetDec}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem">
										<div class="layui-input-inline">
											<input type="number" name="budgetDec"
												class="layui-input form-control j-monthCalc" />
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list2" style="width: 80px;">
									...
									<div class="layui-input-inline item copyAddItem">
										<button type="button"
											class="layui-btn layui-btn-sm newProjectDelete-hook"
											style="vertical-align: top; background-color: #FF5722;">
	...
	layui
			.use(
					...
					function() {
						...
						// 新增新客户
						$("#budget-addForm-hook #addCustomer-form").click(
								function() {
									$.ajax({
										type : "GET",
										url : "trTempl",
						...
						// 删除客户
						$("#budget-addForm-hook").on("click",
								".deleteCustomer-hook", function() {
									var _this = this;
						...
						$("#budget-addForm-hook")
								.on(
										"click",
										".projectNameQuery-hook",
										function() {
											// 当前按钮坐标
											var _YIndex = $(this).parents("tr")
													.index();
											var _index = $(this).parents(
													".item").index();
											$
													.openWindow({
														url : 'wbs?act=addProjectName&index='
																+ _index
																+ '&YIndex='
																+ _YIndex,
														title : "选择项目名称",
						...
						$("#budget-addForm-hook")
								.on(
										...
										function() {
											...
											$
													.openWindow({
														url : 'product?act=formProduct&index='
																+ _index
																+ '&YIndex='
																+ _YIndex,
														title : "选择产品",
						...
						// 保存
						$("#budget-addForm-hook #customGroup-add-hook")
								.click(
										function() {
											var res = [];//结果集
											var res3 = [];
						...
						// 关闭
						$("#budget-addForm-hook #customerGroup-close-hook")
								.click(function() {
									win.close();
									return false;
								})
