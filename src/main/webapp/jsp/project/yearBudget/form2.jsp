						...
						<tr>
							<td>
								...
								<div>
									...
									<button type="button" custId="longshangCode"
										...
										style="vertical-align: top;; margin-top: 10px;; background-color: #FF5722;">
									...
									<div class="layui-input-inline item copyAddItem"
										...
										<div class="layui-input-inline">
											<select name="projectType" lay-verify="required"
												lay-filter="projectType-filter" class="form-control">
							...
							<td>
								<div class="project-list">
									...
									<div class="layui-input-inline item copyAddItem"
										style="margin: 5px;">
										<div class="layui-input-inline">
											<span class="j-budgetYear">${budgetYear }</span> <input
												type="hidden" name="budgetYear" value="${budgetYear }" />
										</div>
									</div>
								</div>
							</td>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item" style="margin: 5px;">
											<select name="taxType" lay-verify="required"
												value='${app2.taxType}' lay-filter="" class="form-control">
												${taxType.ewTypeHtml}
											</select>
									...
									<div class="layui-input-inline item copyAddItem"
										style="margin: 5px 0;">
										<div class="layui-input-inline">
											<select name="taxType" lay-verify="required" lay-filter=""
							...
							<td>
								<div class="project-list">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item" style="margin: 5px;">
											<select name="revRecognitionMethod" lay-verify="required"
												value='${app2.revRecognitionMethod}' lay-filter=""
												class="form-control">
									...
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item" style="margin: 5px;">
											<select name="region" lay-verify="required"
												value='${app2.region}' lay-filter="" class="form-control">
												${region.ewTypeHtml}
											</select>
										</div>
									</c:forEach>
							...
							<td>
								<div class="project-list">
									<c:forEach items="${currency.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item" style="margin: 5px;">
											<select name="region" lay-verify="required"
												value='${app2.currency}' lay-filter="" class="form-control">
												${currency.ewTypeHtml}
											</select>
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem"
										style="margin: 5px 0;">
										<div class="layui-input-inline">
											<select name="currency" lay-verify="required" lay-filter=""
												class="form-control"> ${currency.ewTypeHtml}
											</select>
										</div>
									</div>
								</div>
							...
							<td>
								<div class="project-list manyYearRev">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item" style="margin: 5px;">
											<input type="number" name="manyYearRev"
												value="${app2.manyYearRev}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem"
										style="margin: 5px 0;">
							...
							<td>
								<div class="project-list curYearRev">
									<c:forEach items="${app.pmYearBudgetEntity}" var="app2">
										<div class="layui-input-inline item" style="margin: 5px;">
											<input type="number" name="curYearRev"
												value="${app2.curYearRev}" />
										</div>
									</c:forEach>
									<div class="layui-input-inline item copyAddItem"
										style="margin: 5px 0;">
							...
							<td>
								<div class="project-list">
									...
									<div class="layui-input-inline item copyAddItem"
										style="margin: 5px 0;">
										<div class="layui-input-inline">
											<input type="number" name="afterTax"
												class="layui-input form-control" />
										</div>
									</div>
								</div>
	...
	layui
			.use(
					...
					function() {
						...
						// 手书时去掉 custId
						$("#budget-addForm-hook input[name=custName]")
								.keyup(
										function() {
											$(
													"#budget-addForm-hook input[name=custId]")
													.val("")
										});
						//若项目类型选择产品，则产品名称列提供产品信息清单供选择
						$("#budget-addForm-hook")
								.on(
										'select(projectType-filter)',
										function(data) {
											var index = $(this)
													.parents(".item").index();
