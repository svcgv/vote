...
<div id="cost-edit-hook" class="cost-form-wrapper" style="margin-top:10px;">
		    ...
		    <div class="layui-inline">
			      <label class="layui-form-label">成本中心编号：</label>
			       <div class="layui-input-inline">
			         <input type="text" name="costId" id="costId" value="${Cost.costId}" readonly='true' autocomplete="off" class="layui-input form-control">
		     ...
		     <div class="layui-inline">
			      ...
			      <div class="layui-input-inline">
				       <input type="text" name="orgName"  value="${Cost.orgName}"  autocomplete="off" class="layui-input form-control">
				       <inpu type="text" style='display:none' name="orgId" value="${Cost.orgId}" />
			      </div>
...
// 	   form.render();
	  ...
	  // 选择销售部门
	  $("#cost-edit-hook #sellDeptNameQuery-hook").click(function(){
		  $.openWindow({
		  		url:'org?act=edit',
		  		title:"选择销售部门",
		  		width:"400"
	...
	var win=$("#cost-edit-hook").getWindow();
	// 保存
	$("#cost-edit-hook #customGroup-edit-hook").click(function(){
		
		
		
		var formDatas=$("#cost-edit-hook form").serializeObject();
		 var newparam = {}
	...
	// 关闭
	$("#cost-edit-hook #customerGroup-close-hook").click(function(){
		win.close();
		return false;
	})
