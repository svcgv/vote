		   ...
		   <div class="layui-inline">
	 	   ...
	 	   <div class="layui-inline" style="vertical-align: top;">
			   <div class="layui-btn-container" style="margin-left:43px;">
			    ...
			    <button type="button" class="layui-btn layui-btn-sm" id="add-hook" power="102801"  style="margin-right:15px;"><i class="layui-icon"></i>新增</button>
			  </div>
		   </div>
	   </div>
	</form>
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" power="102802" lay-event="edit">编辑</a>
  <a class="layui-btn layui-btn-xs layui-btn-xs"  power="102803" lay-event="tenderReview">提交评审</a>
  <a class="layui-btn layui-btn-xs layui-btn-xs"  power="102805" lay-event="view">查看</a>
  <a class="layui-btn layui-btn-danger layui-btn-xs" power="102805" lay-event="del">删除</a>
</script>
...
layui.use(['layer', 'form','laydate','table','upload'], function(){
  ...
  table.render({
	    ...
	    cols: [[
            ...
            {field:'predictPeriodStart', title:'项目计划开始日期'},
            {field:'predictPeriodEnd', title:'项目计划结束日期'},
