			...
			<div class="row">
				<form method="post" id="i-form" class="form-horizontal col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<select  class="form-control col-xs-11" id="orgType" name="orgType">
							${codeData.ewTypeHtml }
						</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" col-md-5">
							...
							id="birthDate" onClick="WdatePicker()" name="birthDate" value="${usrInfo.birthDate }"/>
						</div>
					</div>
						<div class="form-group">
