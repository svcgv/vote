...
<script type="text/javascript">
	...
	function save() {
		...
		$.indi.ajaxSubmit({url: "${ctx}/hpb/saveModifyHpbInfo",success:function(data){
			if(data.status == true){
				layer.alert('区县修改成功！',{icon: 1}, function(index){
...
<body class="body-modle">
	<div  class=content >
		<div class="row">
			...
			<input type="hidden" id="hpbid" name="hpbid"  value="${hpbid}"/>
				<fieldset class="content">
				<div class="form-group">
					<label class="col-xs-4 control-label text-right">区县编码</label>
					<div class=" col-xs-6">
							<input type="number" class="form-control col-xs-11"
							placeholder="区县编码" id="hpbbm" name="hpbbm"  minlength="4" maxlength="4" value="${hpb.hpbbm}"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class=" col-xs-6">
						<input type="text" class="form-control col-xs-11"
							placeholder="区县名称" id="hpbmc" name="hpbmc" maxlength="80" value="${hpb.hpbmc}"/>
						<p class="help-block"></p>	
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-4 control-label text-right">区县备注</label>
					<div class=" col-xs-6">
						<textarea type="text" class="form-control col-xs-11" 
							placeholder="区县备注" id="bz" name="bz" rows="5" maxlength="512">${hpb.bz}</textarea>
					</div>
				</div> 
