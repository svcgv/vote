...
public abstract class Assert {
	...
	/**
	 * Assert a boolean expression, throwing <code>BusinessException</code>
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws BusinessException if the object array is <code>null</code> or has no elements
	 */
	 ...
	 * @param array the array to check
	 * @param message the exception message to use if the assertion fails
	 * @throws BusinessException if the object array contains a <code>null</code> element
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws BusinessException if the collection is <code>null</code> or has no elements
	 */
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws BusinessException if the map is <code>null</code> or has no entries
	 */
	 ...
	 * throw BusinessException on an assertion failure.
	 ...
	 * throw {@link BusinessException} on an assertion failure.
